...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { GRAPH_CreateIndirect, "Graph", ID_GRAPH_0, 78, 58, 200, 100, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Button", ID_BUTTON_0, 86, 237, 80, 20, 0, 0x0, 0 },
  { LISTWHEEL_CreateIndirect, "Listwheel", ID_LISTWHEEL_0, 297, 237, 126, 50, 0, 0x0, 0 },
  { MULTIEDIT_CreateIndirect, "Multiedit", ID_MULTIEDIT_0, 507, 89, 80, 60, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_0, 455, 213, 80, 20, 0, 0x64, 0 },
